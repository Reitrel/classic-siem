...
| Что было | Что стало |
|----------|-----------|
| `Normalizer | ⏳ В разработке` | `Normalizer | ✅ Готов (v0.2.0)` |
| Нет упоминания скорости | Добавлена производительность: `~1 182 000 строк/сек` |
| Не было упоминания `normalizer.sh` в структуре | Добавлен `normalizer.sh` |

---

## 📋 Как обновить README.md

1. Открой `https://github.com/Reitrel/classic-siem`
2. Нажми на `README.md`
3. Нажми **✏️ (Edit)**
4. Удали старый текст и **вставь новый** (код выше)
5. Внизу напиши: `docs: обновлён README.md — Normalizer v0.2.0 готов`
6. Нажми **Commit changes**

---

Теперь твой README.md полностью соответствует актуальному состоянию проекта! 🚀
