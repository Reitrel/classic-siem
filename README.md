...
### 3. Завершение процесса сборки логов
После завершения сбора выводится сообщение об окончании сбора, а так же название файла где сохранены Логи.

![Сбор завершён](screenshots/03_end_save.png)

### 4. Статистика по данным
Выводится статистика сколько всего собрано данных.
...
![Статистика](screenshots/05_stats.png)

### 6. Завершение работы
Финальное окно с адресом к сохранённому файлу.

![Завершение](screenshots/06_complete.png)

### 7. Пример собранных логов
Первые 20 строк собранного лог-файла.

![Пример логов](screenshots/07_logs_sample.png)
