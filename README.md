...
- 📋 **Корреляция** — обнаружение аномалий (брутфорс) и генерация алертов (модуль Correlator)
...
| Correlator | ✅ Готов (v0.1.1) | Обнаружение брутфорса |
...
## 📸 Демонстрация работы модуля **correlator.sh**

### 1. Запуск и результат работы коррелятора
![Алерт о брутфорсе](screenshots/1_correlator.png)

### 2. Обнаружение брутфорса
![Алерт о брутфорсе](screenshots/2_correlator.png)
---
